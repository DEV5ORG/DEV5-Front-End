...
const Home = observer(() => {
  ...
  // useFocusEffect para que actualice los eventos cada vez que se muestra la pantalla,
  // muchas veces los tabs mantienen el componente montado entonces useEffect no es suficiente
  useFocusEffect(
    useCallback(() => {
